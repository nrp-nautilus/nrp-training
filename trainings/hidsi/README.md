...
Jupyter notebooks, LLM-as-a-service, AI workflows, AI chatbots, agentic AI — are
...
| # | Lesson | Time | Covers |
|---|---|---|---|
| 1 | [NRP, Access & Requesting Resources](lessons/1_intro.md) | 20 min | What NRP is, CILogon access, namespaces, CPUs/GPUs/Qualcomm Cloud AI 100, the three ways to request resources |
| 2 | [AI for the Classroom](lessons/2_ai_classroom.md) | 30 min | Hosted chatbots, the managed LLM endpoint, Jupyter AI, the `openai` SDK, RAG, agentic AI development |
